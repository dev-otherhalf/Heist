// =============================================================================
// Clean job — rolls the video-number digits ("24724 1632 248") up to their
...
const mount = (section) => {
  ...
  const instance = new CleanJob(section);
  instance.init();
...
document.querySelectorAll("[data-clean-job]").forEach(mount);

document.addEventListener("shopify:section:load", (event) => {
  event.target.querySelectorAll("[data-clean-job]").forEach(mount);
});

document.addEventListener("shopify:section:unload", (event) => {
  event.target.querySelectorAll("[data-clean-job]").forEach(unmount);
});
