  ...
  T extends Promise<infer R>
    ...
    : T extends (infer U)[]
      ...
      : T extends Record<string, any>
        ? {
            [K in keyof T]: K extends "id" | "merchandiseId"
              ? StringToGidInput<T[K]>
              : WithGidInput<T[K]>;
          }
        : T;
...
declare function getCollectionSortKey(
  searchParams?: URLSearchParams,
): CollectionUpdatePayload["sortKey"];
declare function getSearchSortKey(
  searchParams?: URLSearchParams,
): SearchUpdatePayload["search"]["sortKey"];
...
declare class CartLinesUpdateEventImpl<
  TAction extends CartLinesUpdatePayload["action"] =
    CartLinesUpdatePayload["action"],
...
export type CartLinesUpdateEvent<
  TAction extends CartLinesUpdatePayload["action"] =
    CartLinesUpdatePayload["action"],
> = TAction extends CartLinesUpdatePayload["action"]
  ? CartLinesUpdateEventImpl<TAction>
  : never;
...
export type ViewEventElementBase = new (
  ...args: any[]
) => HTMLElement & CustomElementLike;
/**
 ...
 */
export declare function createViewEventElement<
  TBase extends ViewEventElementBase = typeof HTMLElement,
>(Base?: TBase, options?: ViewEventOptions): ViewEventElementClass<TBase>;
